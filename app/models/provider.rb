class Provider
  ...
  ALL_ORGANISATIONS = [
    ...
    new('Hull', 'bc588eed-fc08-4448-b793-a287e417c2be'),
    ...
    new('Cardiff and the Vale', '525da418-ff2c-4522-90a9-bc70ba4ca78b'),
    new('Plymouth', 'c312229b-c96d-49d0-8362-4a3f746b3ac4'),
    new('Shrewsbury', '138175c6-02be-4f44-b08e-929c80e6598c'),
