...
RSpec.feature 'Pension Wise imports historical data' do
  scenario 'All records import successfully' do
    ...
    and_existing_guiders_that_will_map
  ...
  def and_existing_guiders_that_will_map
    create(:guider, name: 'Waheeda Noormohamed', uid: '1d616b80-7355-0134-fe9d-5eea3e482a8b')
  end
