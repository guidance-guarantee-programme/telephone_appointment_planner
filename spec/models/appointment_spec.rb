...
RSpec.describe Appointment, type: :model do
  ...
  describe 'Booking an appointment within the schedule type window' do
    context 'when the appointment is PSG/DD' do
      it 'validates the end of the window correctly' do
        ...
        @appointment.start_at = BusinessDays.from_now(81).beginning_of_day
    ...
    context 'when the appointment is PW' do
      ...
      context 'when the appointment is ad-hoc' do
        it 'permits bookings past the window' do
          @appointment = build(:appointment, start_at: BusinessDays.from_now(81).beginning_of_day)
          expect(@appointment).to be_invalid
  ...
  describe 'validations' do
    ...
    it 'cannot be booked further ahead than 80 working days' do
      subject.start_at = BusinessDays.from_now(81)
      subject.validate
      expect(subject.errors[:start_at]).to_not be_empty
    end
