module Sections
  class SingleDay < SitePrism::Section
    element :date, '.t-date'
    element :start_at_hour, '#batch_upsert_holidays_single_day_start_at_4i'
    element :start_at_minute, '#batch_upsert_holidays_single_day_start_at_5i'
    element :end_at_hour, '#batch_upsert_holidays_single_day_end_at_4i'
    element :end_at_minute, '#batch_upsert_holidays_single_day_end_at_5i'
